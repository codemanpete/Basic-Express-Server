...
if (process.env.NODE_ENV === 'test')
    mongoose.connect('mongodb://localhost/catsdemotest', { useNewUrlParser: true, useFindAndModify: false });
else
    mongoose.connect('mongodb://localhost/catsdemo', { useNewUrlParser: true, useFindAndModify: false });
